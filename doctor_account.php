...
$query = "SELECT * FROM doctor_mast WHERE d_id = '$doctor_id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    if ($password === $doctor['password']) {
        $update_query = "UPDATE doctor_mast SET name='$name', email='$new_email' WHERE d_id='$doctor_id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['change_password'])) {
    ...
    if ($password === $doctor['password']) {
        if ($new_password === $confirm_password) {
            $update_query = "UPDATE doctor_mast SET password='$new_password' WHERE d_id='$doctor_id'";
            if (mysqli_query($conn, $update_query)) {
...
<body>
    <header>
        <h2>Your Account</h2>
        <nav>
            <a href="doctor_index.php">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="container">
        <section class="sec">
            ...
            <p><strong>Name:</strong> <?php echo htmlspecialchars($doctor['name']); ?></p><br>
            <p><strong>Email:</strong> <?php echo htmlspecialchars($doctor['email']); ?></p><br>
            <p><strong>Password:</strong> <?php echo str_repeat('*', strlen($doctor['password'])); ?></p><br>
            ...
            <form method="POST" id="update-info-form" class="form-section">
                ...
                <input type="text" id="name" name="name" class="ipt1" value="<?php echo htmlspecialchars($doctor['name']); ?>" required><br>

                <label for="email">New Email:</label>
                <input type="email" id="email" name="email" class="email-pass" value="<?php echo htmlspecialchars($doctor['email']); ?>" required><br>
